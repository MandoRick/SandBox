...
void drawDisplay() {
  ...
  dotDistance = map(distance_cm, 0, 180, 156, 0);
  if (distance_cm >= 181) {
    dotDistance = 0;
  }
  ...
  tft.drawLine(sweepMapX + 3, 160, sweepMapX + 3, 0, TFT_BLACK);
  tft.drawLine(sweepMapX - 4, 160, sweepMapX - 4, 0, TFT_BLACK);
  tft.drawLine(sweepMapX + 4, 160, sweepMapX + 4, 0, TFT_BLACK);
  ...
  tft.drawLine(sweepMapX + 1, 160, sweepMapX + 1, 0, TFT_DARKGREEN);
  tft.drawLine(sweepMapX - 2, 160, sweepMapX - 2, 0, TFT_DARKGREEN);
  tft.drawLine(sweepMapX + 2, 160, sweepMapX + 2, 0, TFT_DARKGREEN);
